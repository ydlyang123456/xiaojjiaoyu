...
import com.studycheck.student.databinding.ItemSearchRecordBinding
...
) : RecyclerView.Adapter<SearchRecordAdapter.RecordViewHolder>() {

    inner class RecordViewHolder(private val binding: ItemSearchRecordBinding) :
