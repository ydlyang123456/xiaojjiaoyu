...
import com.studycheck.student.databinding.FragmentRecordsBinding
import com.studycheck.student.network.ApiClient
import com.studycheck.student.ui.search.SearchDetailActivity
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class ParentRecordsFragment : Fragment() {
    ...
    private fun loadRecords() {
        ...
        ApiClient.apiService.getSearchRecords(1, 20)
